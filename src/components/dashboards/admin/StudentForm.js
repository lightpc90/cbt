...
const StudentForm = ({ student, num, isEditing, setIsEditing }) => {
    ...
    const handleRegisterOrUpdate = async () => {
        if (!formData.firstname || !formData.middlename || !formData.lastname || !formData.matricNo || !formData.dept || !formData.gender) {
    ...
    return (
        <div className='h-[92%] w-full overflow-auto flex flex-col p-2'>
            <div className='space-y-2'>
                ...
                <select className='block text-slate-900 py-1 px-2 rounded-md hover:bg-rose-500' required
