...
async function getLiveCourses() {
  const res = await fetch('http://localhost:3000/api/course/fetchLiveCourses')
...
const page = async ({ params }) => {
  ...
  const studentData = { _id: '123', firstname: "Gideon", lastname: "Abbey", dept: "Robotics and Mechatronics", level: "100", studentID: "2017/RTM/0923", result: [{ code: '', score: '', }] }
