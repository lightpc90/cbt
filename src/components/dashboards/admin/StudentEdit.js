    ...
    <div className='max-w-[450px] max-h-[900px] bg-slate-900 py-12 px-5 overflow-auto'>
      ...
      <div className='mt-10'>
        ...
        {openDeletBox && <div>
          ...
          <button  disabled={()=>confirmDeleteInfo()} onClick={handleStudentDelete} className='bg-rose-900 py-1 px-2 hover:bg-rose-700' >{isDeleting ? `Deleting...` : `Delete Student`}</button>
